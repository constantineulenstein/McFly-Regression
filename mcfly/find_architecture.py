...
def find_best_architecture(X_train, y_train, X_val, y_val, verbose=True,
                           ...
                           outputpath=None, model_path=None, metric='mean_absolute_error',
                           class_weight=None,
                           **kwargs):
    """
    ...
    **kwargs: key-value parameters
    ...
    if verbose:
        ...
        print('MAE of kNN on validation set', knn_acc)
...
def kNN_accuracy(X_train, y_train, X_val, y_val, k=1):
    ...
    return sklearnmetrics.mean_absolute_error(val_predict, y_val)
